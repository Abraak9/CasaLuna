  ...
  return (
    <div style={{ maxWidth: '640px' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '28px' }}>
        ...
        <h1 style={{ fontFamily: 'var(--font-cormorant)', fontSize: '26px', fontWeight: 600, color: 'var(--text)' }}>New Event</h1>
      </div>
      ...
      <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
        ...
        <div style={CARD}>
          ...
          <div>
            ...
            <input value={form.name} onChange={e => set('name', e.target.value)} required placeholder="e.g. La Luna Social Night" style={INPUT} />
          </div>
          <div>
          ...
          <div>
            ...
            <textarea value={form.description} onChange={e => set('description', e.target.value)} rows={4} placeholder="Tell attendees what to expect…" style={{ ...INPUT, resize: 'vertical' }} />
          </div>
        </div>
        ...
        <div style={CARD}>
          ...
          <div>
            ...
            <input value={form.location_name} onChange={e => set('location_name', e.target.value)} placeholder="e.g. Studio 54" style={INPUT} />
          </div>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px' }}>
            <div>
        ...
        <div style={CARD}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px' }}>
            <div>
              ...
              <input value={form.checkin_pin} onChange={e => set('checkin_pin', e.target.value)} placeholder="e.g. 1234" style={INPUT} />
            </div>
            <div>
              <label style={LABEL}>Max capacity</label>
              <input type="number" value={form.max_capacity} onChange={e => set('max_capacity', e.target.value)} placeholder="300" style={INPUT} />
            </div>
          </div>
          <div>
