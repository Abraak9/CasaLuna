    ...
    <main style={{ minHeight: '100vh', background: 'var(--bg)', paddingBottom: totalItems > 0 ? '120px' : '60px' }}>
      ...
      {step === 'browse' && (
        <div style={{ maxWidth: '640px', margin: '0 auto', padding: '0 20px 120px' }}>
                    ...
                    <div key={ticket.id} style={{ background: 'var(--surface)', border: `1px solid ${qty > 0 ? 'var(--border)' : 'var(--border-muted)'}`, borderRadius: '14px', padding: '18px 20px', opacity: available ? 1 : 0.5, transition: 'border-color 0.2s' }}>
                      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '16px' }}>
                        <div style={{ flex: 1, minWidth: 0 }}>
                          ...
                          <p style={{ fontFamily: 'var(--font-cormorant)', fontSize: '22px', fontWeight: 600, lineHeight: 1 }} className="cl-gold-text">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '10px', paddingTop: '24px' }}>
      ...
      {step === 'attendees' && (
        <div style={{ maxWidth: '640px', margin: '0 auto', padding: '0 20px 120px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '10px', paddingTop: '4px' }}>
            <div style={{ width: '100%', height: '1px', background: 'linear-gradient(90deg, transparent, var(--border), transparent)' }} />
            <p style={{ fontSize: '12px', color: 'var(--text-dim)', textAlign: 'center' }}>
              That&apos;s everything — tap <span style={{ color: 'var(--gold)', fontWeight: 600 }}>Review Order →</span> to continue
            </p>
          </div>
        </div>
      )}
        ...
        <div style={{ maxWidth: '640px', margin: '0 auto', padding: '0 20px 120px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
          <div style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: '14px', padding: '20px' }}>
            ...
            <div style={{ borderTop: '1px solid var(--border-muted)', paddingTop: '14px' }}>
              <p style={{ fontSize: '12px', color: 'var(--text-dim)' }}>Tickets will be sent to <strong style={{ color: 'var(--text)', fontWeight: 600 }}>{email}</strong></p>
            </div>
          </div>
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '10px' }}>
            <div style={{ width: '100%', height: '1px', background: 'linear-gradient(90deg, transparent, var(--border), transparent)' }} />
            <p style={{ fontSize: '12px', color: 'var(--text-dim)', textAlign: 'center' }}>Review complete — tap <span style={{ color: 'var(--gold)', fontWeight: 600 }}>Pay</span> to complete your order</p>
          </div>
      ...
      {/* ── Sticky CTA ── */}
      {totalItems > 0 && (
        <div style={{ position: 'fixed', bottom: 0, left: 0, right: 0, background: 'rgba(9,9,15,0.95)', backdropFilter: 'blur(20px)', borderTop: '1px solid var(--border)', padding: '16px 20px', zIndex: 40, maxWidth: '640px', marginLeft: 'auto', marginRight: 'auto' }}>
